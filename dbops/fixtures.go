...
func FixturesFill(db *mongo.Database)  {
	...
	fUnits = []models.Unit{
		{ Name: "Grams", Units: []string{"mg", "g", "kg"},
			Quantities:[]int{1, 1000, 1000000}, Id: primitive.NewObjectID()},
		{ Name: "Liters", Units: []string{"mL", "cL", "L"},
			Quantities:[]int{1, 10, 1000}, Id: primitive.NewObjectID()}}
	...
	fRecipes = []models.Recipe{
		...
		IngredientIDs: []primitive.ObjectID{fIngredients[0].Id}},
